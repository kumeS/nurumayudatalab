...
🌐 **Website**: [https://nurumayudatalab.com](https://nurumayudatalab.com)

## Project Concept

**WebApp × GenAI Innovation for Efficiency Enhancement Tools**

Nurumayu Data Lab (ぬるま湯データラボ) represents the cutting-edge fusion of Web Applications and Generative AI technology, focused on creating and delivering a vast collection of practical mini-applications. Our core mission is to develop innovative tools that combine the latest AI technology with web applications, providing easy-to-use, practical solutions that "gently" (ぬるっと) enhance efficiency in business operations, daily life, and data analysis.
...
- **Mobile Optimized**: Responsive design for seamless experience on all devices

**Language Support**: Tools are primarily available in Japanese and English. We are happy to release tools in other languages upon request. Please [create a new issue](https://github.com/kumeS/nurumayudatalab/issues/new) if you need support for a specific language.

## Provided Tools

### 🤖 General AI Tools (一般利用AIツール)

#### [Multi-LLM System (マルチLLMシステム)](https://nurumayudatalab.com/webtool-multiLLM/index.html)
...
#### [Nurumayu Translation & Proofreading Tool (ぬるっと翻訳・校閲ツール)](https://nurumayudatalab.com/webtool-LLMworker-translator/index.html)
...
### 🏠 Lifestyle AI Tools (生活系AIツール)

#### [LLM Weather Forecast Web Tool (LLMと天気予報ウェブツール)](https://nurumayudatalab.com/webtool-whether/index.html)
...
#### [AI Cooking Suggestion System (AI料理提案システム)](https://nurumayudatalab.com/webtool-ai-cooking/index.html)
...
#### [DIY Assistant β | AI 3D Furniture Design Tool (DIYアシスタントβ)](https://nurumayudatalab.com/webtool-DIY-assist/index.html)
...
### 🎓 Educational AI Systems (教育系AIシステム)

#### [K-12 Quiz Auto-Generator (小中高生向けクイズ自動作成ツール)](https://nurumayudatalab.com/webtool-quiz/index.html)
...
#### [AI Training Quiz Auto-Generator (AI研修クイズ自動作成ツール)](https://nurumayudatalab.com/webtool-ai-quiz/index.html)
...
#### [NuruMayu StudyLab](https://nurumayudatalab.com/webtool-OCR2/index.html)
- **OCR Integration**: Extract text from educational materials using optical character recognition
- **AI-Powered Summaries**: Automatically generate concise summaries from imported learning materials
- **Quiz Generation**: Create custom quizzes based on OCR-extracted content for effective learning
- **Comprehensive Learning Platform**: All-in-one AI learning support platform for students

### 🛒 E-commerce Tools (EC系ツール)

#### [Keyword Manager v2 (キーワードマネージャーv2)](https://nurumayudatalab.com/webtool-ec-keyword-tool/index.html)
...
#### [A+ Content Generator (A+ コンテンツジェネレーター)](https://nurumayudatalab.com/webtool-aplus-br-generator/index.html)
...
#### [Keyword Integration Checker Machine (キーワード組み込みチェックマシーン)](https://nurumayudatalab.com/webtool-matching-machine/index.html)
...
#### [Amazon Profit Calculator (Amazon 利益計算ツール)](https://nurumayudatalab.com/webtool-ec-calc-amazon/index.html)
- **Comprehensive Profit Analysis**: Automatically calculate profits from Amazon Japan domestic sales
- **Fee Deduction**: Automatically deducts various sales fees from sales prices to compute gross and net profits
- **Real-time Calculation**: Instant profit calculations for quick business decisions

### ⚙️ Domain-Specialized AI Systems (分野特化AIシステム)

#### [AI Plant Dictionary (AI植物辞典)](https://nurumayudatalab.com/webtool-plant-dic/index.html)
...
#### [AI Yokai Dictionary (AI妖怪辞典)](https://nurumayudatalab.com/webtool-yokai/index.html)
...
#### [AI Dangerous Creature Dictionary (AI危険生物辞典)](https://nurumayudatalab.com/webtool-dangerous-creature/index.html)
...
### 🖼️ Image Editing Tools (画像編集ツール - Under Development)

#### [FleMa - Flea Market Image Editor (FleMa - フリマ専用画像編集)](https://nurumayudatalab.com/webtool-ec-flema-image-tool/index.html)
- **Flea Market Optimization**: Specialized image editor for online marketplace listing photos
- **Smart Text Overlays**: Add attention-grabbing text like "Brand New", "Free Shipping" to boost sales
...
### [Analysis Portal](https://nurumayudatalab.com/Analysis.html)

#### [NEKO Bot Demo](https://nurumayudatalab.com/Analysis-Chat/index.html)
- **Literary AI Assistant**: A chatbot well-versed in "I Am a Cat" (吾輩は猫である) by Natsume Soseki
- **Data Analysis Support**: Feel free to ask questions about data analysis techniques and methodologies
- **Interactive Conversations**: Engaging AI-powered chat interface for learning and assistance

#### [Optimal Transport Analyzer Demo](https://nurumayudatalab.com/Analysis-OT/index.html)
- **State Transition Analysis**: Analyzes state transitions using optimal transport theory
- **A→B→C Pattern Visualization**: Visualizes branching patterns in data flow and state changes
- **Wasserstein Distance**: Quantitative evaluation using Wasserstein distance metrics
- **Advanced Analytics**: Cutting-edge mathematical approach to understanding data transitions

#### More Analysis Tools
- Currently under development with additional specialized analytics tools coming soon
...
- **Processing**: Client-side processing for maximum privacy and security
- **AI Integration**: Multiple LLM APIs for intelligent automation
- **3D Graphics**: Three.js and WebGL for 3D visualization
